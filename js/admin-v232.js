...
const ARQUIVOS_TELAO_OFFLINE = [
    ...
    './css/global.css', './css/telao-evento-v234.css', './css/sorteio-telao.css',
    './js/admin-v232.js', './js/firebase-config.js', './js/telao-evento.js', './js/sorteio-telao-v234.js', './js/qrcode.min.js',
    ...
    './assets/img/telao-jogos-celular.png', './assets/img/telao-lojinha-cesta.png', './assets/img/telao-sorteio-urna.png',
